...
const DICT: Dict = {
  ...
  // Hero
  hero_kicker: { tr: "339 MODEL · 56 SAĞLAYICI · TEK EKRAN", en: "339 MODELS · 56 PROVIDERS · ONE SCREEN" },
  hero_title_1: { tr: "OpenRouter'daki her modeli", en: "Compare every model on" },
  hero_title_2: { tr: "kıyasla, seç, anla.", en: "OpenRouter. Pick & understand." },
  hero_sub: {
  ...
  search_ph: { tr: "Model veya sağlayıcı ara…", en: "Search model or provider…" },
  ...
  no_results_sub: { tr: "Filtreleri gevşetmeyi deneyin.", en: "Try relaxing your filters." },
  na_bench: { tr: "Bu model için bağımsız benchmark verisi yok", en: "No independent benchmark for this model" },
  ...
  min_two: { tr: "Karşılaştırmak için en az 2 model seçin.", en: "Select at least 2 models to compare." },
  // Categories page
  cat_title: { tr: "Kullanım Alanına Göre Kategoriler", en: "Categories by Use Case" },
  cat_sub: { tr: "Her kategori, o görev için en uygun modelleri gruplar. Bir karta tıklayıp o kategoriyi keşfedin.", en: "Each category groups the best-fit models for that task. Click a card to explore it." },
  ...
  adv_sub: { tr: "Önceliklerinizi ayarlayın, size en uygun modelleri sıralayalım.", en: "Set your priorities and we'll rank the best-fit models for you." },
  ...
  adv_results: { tr: "Sizin için en iyi eşleşmeler", en: "Best matches for you" },
  adv_match: { tr: "uyum", en: "match" },
  adv_why: { tr: "Neden bu model?", en: "Why this model?" },
  adv_none: { tr: "Kriterlere uyan model bulunamadı. Zorunlu yetenekleri azaltın.", en: "No models match. Try removing required capabilities." },
  view_in_table: { tr: "Tabloda gör", en: "View in table" },
  // misc
  free: { tr: "Ücretsiz", en: "Free" },
  footer_note: { tr: "Veriler OpenRouter API'sinden; benchmark & hız tahminleri Artificial Analysis ve sektörel kaynaklardan derlenmiştir. Bilgilendirme amaçlıdır.", en: "Data from the OpenRouter API; benchmark & speed estimates compiled from Artificial Analysis and industry sources. For informational purposes." },
  built: { tr: "Manus AI tarafından hazırlandı", en: "Built by Manus AI" },
