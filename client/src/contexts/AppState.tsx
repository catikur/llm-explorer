...
export function AppStateProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo(
    () => ({ selected, toggleSelect, clearSelected, isSelected, compareOpen, setCompareOpen, presetUsecase, setPresetUsecase }),
    [selected, toggleSelect, clearSelected, isSelected, compareOpen, presetUsecase]
  );
